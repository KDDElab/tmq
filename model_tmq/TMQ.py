...
class TMQ:
    def __init__(self, nbrs_num=50, rand_num=50, nrand_num=1, alpha1=0.8, alpha2=0.2,
    ...
    def fit(self, x, y):
        ...
        for ii in iterator:
            ...
            s_t = time.time()
            attn, W,  losses= self.interpret_ano(ii)
            attn_lst.append(attn)
            W_lst.append(W)
            ...
            plt.savefig('losses_1.png',format='png',dpi=1024)#输出
            plt.savefig('losses_1.eps',format='eps',dpi=1024)
            plt.show()
            '''
        ...
        for ii, idx in enumerate(self.ano_idx):
            ...
            weight_lst.append(w)
        return fea_weight_lst, weight_lst
    ...
    def interpret_ano(self, ii, device=None):
        ...
        for epoch in range(self.n_epoch):
            ...
            if early_stp.early_stop:
                ...
                break
            losses.append(total_loss[0].item())
