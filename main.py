...
#from model_aton.ATON_multi_thread import ATON
from model_tmq.TMQ import TMQ
'''
...
od_eval_model = ["iforest", "copod", "hbos", "ecod", "sogaal", "lunar", "rod", "mcd"] # we obtain ground-truth annotations using eight outlier detection methods
runs = args.runs
...
def run_model(algorithm, X, y):
    if algorithm == "tmq":
        model = TMQ(verbose=False, gpu=args.gpu,
