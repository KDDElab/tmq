...
def get_parser(algorithm_name, parser):
    if algorithm_name == "tmq":
        parser.add_argument('--nbrs_num', type=int, default=50, help='')
        parser.add_argument('--rand_num', type=int, default=50, help='')
        parser.add_argument('--alpha1', type=float, default=1, help='triplet loss factor in loss function')
        parser.add_argument('--alpha2', type=float, default=0, help='dis loss factor in loss function')
        parser.add_argument('--n_epoch', type=int, default=40, help='')
        ...
        parser.add_argument('--MAX_NUM_CLUSTER', type=int, default=3,
        ...
        parser.add_argument('--THRE_PS', type=float, default=0.5,
